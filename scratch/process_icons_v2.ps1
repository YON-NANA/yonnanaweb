...
$srcPath = "C:\Users\user\.gemini\antigravity-ide\brain\3036929b-8083-4c94-874b-98c213ee95e3\afc_logo_2x_larger_1785064713003.png"
...
foreach ($s in $sizes) {
    Resize-Image "$baseDir\icons\icon-$s.png" $s $s
}
...
Resize-Image "$baseDir\favicon.ico" 256 256
Resize-Image "$baseDir\icons\favicon-256.ico" 256 256

$srcImg.Dispose()
Write-Host "All 2x scaled icons generated successfully!"
