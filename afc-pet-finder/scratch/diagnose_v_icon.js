...
async function run() {
  console.log('=== Vercel Site Asset Inspection ===');
  const urls = [
    'https://afc-pet-finder.vercel.app/manifest.json',
    'https://afc-pet-finder.vercel.app/favicon.ico',
    ...
    'https://afc-pet-finder.vercel.app/icons/icon-32.png',
    'https://afc-pet-finder.vercel.app/assets/afc-logo-full.png'
  ];
