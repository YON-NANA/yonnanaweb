...
const iconTags = `  <!-- PWA & App Icon -->
  ...
  <link rel="icon" type="image/png" sizes="256x256" href="icons/icon-256.png?v=5">
  <link rel="icon" type="image/png" sizes="192x192" href="icons/icon-192.png?v=5">
  <link rel="icon" type="image/png" sizes="32x32" href="icons/icon-32.png?v=5">
  <link rel="icon" type="image/png" sizes="16x16" href="icons/icon-16.png?v=5">
...
files.forEach(file => {
  ...
  console.log(`Updated v5 icons in ${file}`);
});

console.log('🚀 All HTML files updated with v5 icon links!');
